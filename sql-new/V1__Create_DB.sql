...
CREATE DATABASE [TestDB2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TestDB2', FILENAME = N'/var/opt/mssql/data/TestDB2.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TestDB2_log', FILENAME = N'/var/opt/mssql/data/TestDB2_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
